...
(function (d, r) {
  ...
  function ea (a, b, c) {
    ...
    if (b != null) {
      ...
      b)) { ha.call(b, g) && !ia.hasOwnProperty(g) && (e[g] = b[g]); }
    }
    let h = arguments.length - 2;
    if (h === 1) e.children = c;
    else if (h > 1) {
  ...
  function S (a, b) {
    ...
    a: for (;;) {
      const g = (c - 1) >>> 1;
      const e = a[g];
      if (void 0 !== e && D(e, b) > 0) (a[g] = b), (a[c] = e), (c = g);
      else break a;
    }
  }
  function n (a) {
        ...
        a: for (let g = 0, e = a.length; g < e;) {
          ...
          if (void 0 !== f && D(f, c) < 0) {
            void 0 !== k && D(k, f) < 0
              ? ((a[g] = k), (a[h] = c), (g = h))
              : ((a[g] = f), (a[d] = c), (g = d));
          } else if (void 0 !== k && D(k, c) < 0) (a[g] = k), (a[h] = c), (g = h);
          else break a;
        }
      }
      return b;
  ...
  function F (a) {
    for (let b = n(u); b !== null;) {
      if (b.callback === null) E(u);
      else if (b.startTime <= a) { E(u), (b.sortIndex = b.expirationTime), S(p, b); } else break;
      b = n(u);
    }
  }
  function T (a) {
  ...
  function U (a, b) {
    ...
    try {
      F(b);
      for (l = n(p); l !== null && (!(l.expirationTime > b) || (a && !W()));) {
        const g = l.callback;
        if (g !== null) {
          l.callback = null;
          m = l.priorityLevel;
          const e = g(l.expirationTime <= b);
          b = q();
          typeof e === 'function' ? (l.callback = e) : l === n(p) && E(p);
          F(b);
        } else E(p);
        l = n(p);
      }
  ...
  let f = typeof Symbol === 'function' && Symbol.for;
  var x = f ? Symbol.for('react.element') : 60103;
  var xa = f ? Symbol.for('react.portal') : 60106;
  const Aa = f ? Symbol.for('react.fragment') : 60107;
  const Ba = f ? Symbol.for('react.strict_mode') : 60108;
  const Ca = f ? Symbol.for('react.profiler') : 60114;
  const Da = f ? Symbol.for('react.provider') : 60109;
  const Ea = f ? Symbol.for('react.context') : 60110;
  const Fa = f ? Symbol.for('react.forward_ref') : 60112;
  const Ga = f ? Symbol.for('react.suspense') : 60113;
  const Ha = f ? Symbol.for('react.memo') : 60115;
  const Ia = f ? Symbol.for('react.lazy') : 60116;
  var la = typeof Symbol === 'function' && Symbol.iterator;
  const pa = Object.getOwnPropertySymbols;
  const Ja = Object.prototype.hasOwnProperty;
  const Ka = Object.prototype.propertyIsEnumerable;
  const I = (function () {
    try {
    ...
    : function (a, b) {
      ...
      for (var g, e = 1; e < arguments.length; e++) {
        const d = Object(arguments[e]);
        for (const f in d) Ja.call(d, f) && (c[f] = d[f]);
        if (pa) {
          g = pa(d);
          for (let h = 0; h < g.length; h++) { Ka.call(d, g[h]) && (c[g[h]] = d[g[h]]); }
        }
      }
      return c;
    };
  ...
  w.prototype.setState = function (a, b) {
    if (typeof a !== 'object' && typeof a !== 'function' && a != null) { throw Error(r(85)); }
  ...
  var ia = { key: !0, ref: !0, __self: !0, __source: !0 };
  var ma = /\/+/g;
  var C = [];
  var na = { current: null };
  let X;
  if (typeof window === 'undefined' || typeof MessageChannel !== 'function') {
    ...
    var z = function (a) {
      A !== null ? setTimeout(z, 0, a) : ((A = a), setTimeout(ra, 0));
    };
    var G = function (a, b) {
      qa = setTimeout(a, b);
    };
    ...
    const Y = window.performance;
    const sa = window.Date;
    const Ma = window.setTimeout;
    const Na = window.clearTimeout;
    ...
    Scheduler: {
      ...
      unstable_scheduleCallback: function (a, b, c) {
        ...
        if (typeof c === 'object' && c !== null) {
          ...
          c = typeof c.timeout === 'number' ? c.timeout : oa(a);
        } else (c = oa(a)), (e = d);
        c = e + c;
        a = {
          id: Pa++,
        ...
        e > d
          ? ((a.sortIndex = e),
            S(u, a),
            n(p) === null && a === n(u) && (y ? V() : (y = !0), G(T, e - d)))
  ...
  d.cloneElement = function (a, b, c) {
    if (a === null || void 0 === a) throw Error(r(267, a));
    const d = I({}, a.props);
    let e = a.key;
    let f = a.ref;
    let m = a._owner;
    ...
    if (k === 1) d.children = c;
      ...
      h = Array(k);
      for (let l = 0; l < k; l++) h[l] = arguments[l + 2];
      d.children = h;
    }
